...
export function FuturesTickerStrip() {
  return (
    <div className="futures-workspace-scrollbar flex h-10 shrink-0 items-center gap-6 overflow-x-auto border-b border-slate-800 bg-[#151922] px-4 text-xs font-semibold">
