              ...
              <div className="space-y-8">
                ...
                <div className="space-y-5">
                  ...
                  <p className="max-w-2xl text-base leading-7 text-slate-400 md:text-lg">
                    {APP_NAME} is a Next.js + React + TypeScript architecture
                    lab for modeling spot trading, futures trading, wallet,
                    market data, risk control, mock BFF and realtime streams.
                  </p>
                </div>
          ...
          <PageContainer>
            <div className="mb-8 flex flex-col justify-between gap-4 md:flex-row md:items-end">
              ...
              <p className="max-w-xl text-sm leading-6 text-slate-500">
                The homepage is designed as a professional exchange entry: fast
                product access, market preview, mock trading paths and
            ...
            <div className="grid gap-6 lg:grid-cols-[0.9fr_1.1fr]">
              <div className="rounded-3xl border border-slate-800 bg-slate-950 p-6">
                ...
                <p className="mt-4 text-sm leading-6 text-slate-500">
                  The project homepage intentionally exposes the product
                  domains: spot, futures, wallet, market data, risk and mock
                  stream. This helps you tell a complete system-design story in
                  interviews.
                </p>
